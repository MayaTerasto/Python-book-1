# Списък от числа:
nums = [5, 10, 1, 60, 25, 3]
# Показване съдърванието на списъка:
...
# Последен елемент:
print("Първи елемент:", nums[-1])
# Най-голяма стойност:
print("Най-голяма стойност:", max(nums))
# Най-малка стойност:
print("Най-голяма стойност:", min(nums))
# Сума:
print("Сума:", sum(nums))
# Списък в обратен ред:
print("Списък в обратен ред:", list(reversed(nums)))
# Сортиране по възходяща стойност:
print("По възходяща стойност:", list(sorted(nums)))
# Сортиране по низходяща стойност:
print("По низходяща стойност:", list(sorted(nums,reverse=True)))
# Изходен списък:
...
print("Списъкът след замяна на елементите:", nums)
